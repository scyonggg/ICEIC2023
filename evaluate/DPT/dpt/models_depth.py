...
class DPT_decoder(BaseModel):
    def __init__(
        ...
        super(DPT_decoder, self).__init__()
        ...
        self.scratch.output_conv1 = head

    def forward(self, layer):

        layer_1, layer_2, layer_3, layer_4 = layer[0], layer[1], layer[2], layer[3]
...
class DPTMultiModel(DPT_Multi):
    ...
    def forward(self, x):
        inv_depth, layer = super().forward(x)
...
class DPTSegmentationDecoder(DPT_decoder):
